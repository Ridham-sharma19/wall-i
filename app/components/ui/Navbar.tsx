    ...
    >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse items-center">
          <button
            type="button"
            className="text-white bg-[#012F99] hover:bg-[#001F61]   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl px-5 py-2.5 text-center transition-all duration-100 ease-in-out transform hover:scale-101" 
          >
            Get started
          </button>
          <button
